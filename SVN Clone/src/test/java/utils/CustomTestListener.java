...
public class CustomTestListener extends TestListenerAdapter implements IInvokedMethodListener{
    @Override
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			...
			List<Throwable> verificationFailures = IWebDriver.getVerificationFailures();
